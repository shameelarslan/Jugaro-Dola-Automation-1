        ...
        def run_browser_thread():
            async def _main():
                async with async_playwright() as playwright:
                    ...
                    # Navigate directly to dola.com/chat with cookies already injected
                    try:
                    ...
                    # Keep browser open while user interacts with it
                    try:
                        ...
                        # Clean up: close browser instance
                        browser = getattr(context, '_browser_instance', None)
                        try:
                            await context.close()
                        except Exception:
                            pass
