...
function applyRoleUI(role) {
    ...
    if (isAdmin) {
        ...
        if (headerTitle) headerTitle.innerHTML = `👑 Waqas Automation Pro <span class="version-tag">Admin v2.0.7</span>`;
        ...
        if (headerTitle) headerTitle.innerHTML = `Waqas Automation Pro <span class="version-tag">v2.0.7</span>`;
